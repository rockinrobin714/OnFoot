        ...
        <ul className='row'>
          {
            ...
            <SavedItem addNote={this.props.addNote} deleteFromSavedList={this.props.deleteFromSavedList} item={restaurant} API={this.props.API} displayDirections={this.props.displayDirections}/>
            )
          }
        </ul>
      </div>
